...
from .evaluation import (  # CaptioningEvaluator,
...
def build_eval_dataloader(cfg, ):
    ...
    for dataset_name in cfg['DATASETS']['TEST']:
        ...
        elif dataset_name == 'nuscenes_mini_val_v1':
            # TODO: set to nuscenes mapper
            mapper = NuScenesSemanticSegmentationMapper(cfg, False)
        else:
            mapper = None
